            ...
            using (Transaction trans = new Transaction(doc, "Uppercase View and Sheet Data"))
            {
                try
                {
                    ...
                    if (updatedElements.Any())
                    {
                        ...
                        TaskDialog.Show("RT_UpperCase - Success", successMessage);
                    }
                    else
                    {
                        TaskDialog.Show("RT_UpperCase - No Changes", "No eligible view or sheet parameters were found that required uppercasing based on the defined criteria and exception list, or no changes were necessary.");
                    }
                ...
                catch (Exception ex)
                {
                    ...
                    TaskDialog.Show("RT_UpperCase - Error", message);
