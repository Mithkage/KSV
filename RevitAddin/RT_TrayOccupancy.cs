...
//
#region Namespaces // This line MUST be outside any multi-line comment block and at the start of its line.
using System;
...
            var cableDataLookup = cableScheduleData
                       ...
                       .ToDictionary(cd => cd.CableReference, cd => cd);
...
            public string Variance { get; set; } // New: Stores the calculated percentage variance
