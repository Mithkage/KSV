...
using RTS.UI; // UPDATED: Corrected using directive for ScheduleSelectionWindow
#endregion

namespace RTS.Addin.Commands.RTS_Schedules // UPDATED: Namespace changed from RTS_Schedules to RTS.Addin.Commands.RTS_Schedules
{
    // REMOVED: The ScheduleItem class definition is now solely in RTS.UI.ScheduleSelectionWindow.xaml.cs
    // /// <summary>
    ...
    public class RTS_SchedulesClass : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            // Now explicitly using RTS.UI.ScheduleItem
            var allSchedules = new List<RTS.UI.ScheduleItem> // UPDATED: Changed type to RTS.UI.ScheduleItem
            {
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Sheet List", Category = BuiltInCategory.OST_Sheets, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Detail Items", Category = BuiltInCategory.OST_DetailComponents, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Spaces", Category = BuiltInCategory.OST_MEPSpaces, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Sample Register", Category = BuiltInCategory.INVALID, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Electrical Equipment", Category = BuiltInCategory.OST_ElectricalEquipment, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Lighting Fixtures", Category = BuiltInCategory.OST_LightingFixtures, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Electrical Fixtures", Category = BuiltInCategory.OST_ElectricalFixtures, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Cable Trays", Category = BuiltInCategory.OST_CableTray, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Cable Tray Fittings", Category = BuiltInCategory.OST_CableTrayFitting, IsSelected = false },
                new RTS.UI.ScheduleItem { Name = "RTS_Sc_Conduits", Category = BuiltInCategory.OST_Conduit, IsSelected = false }
            };
            ...
            // Ensure schedulesToProcess also uses the correct type
            List<RTS.UI.ScheduleItem> schedulesToProcess = ui.Schedules.Where(s => s.IsSelected).ToList(); // UPDATED: Changed type to RTS.UI.ScheduleItem
            ...
            RTS.UI.ScheduleItem currentScheduleInfo = null; // UPDATED: Changed type to RTS.UI.ScheduleItem
            ...
            using (Transaction tx = new Transaction(doc, "Manage RTS Schedules"))
            {
                ...
                try
                {
                    if (ui.RemoveAllSelected)
                    {
                        ...
                        // Ensure allSchedules is iterated with the correct type
                        foreach (var scheduleItem in allSchedules) // allSchedules is already RTS.UI.ScheduleItem
                        {
                    ...
                    else
                    {
                        ...
                        // schedulesToProcess is already RTS.UI.ScheduleItem
