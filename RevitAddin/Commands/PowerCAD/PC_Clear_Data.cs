...
namespace RTS.Commands.PowerCAD
{
    ...
    public class PC_Clear_DataClass : IExternalCommand 
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            {
                CustomTaskDialog.Show("Error", "Invalid GUID format for PC_PowerCAD condition parameter.");
            ...
            {
                CustomTaskDialog.Show("Error", $"Error initializing parameter list: {ex.Message}");
                return Result.Failed;
            }
            ...
            if (!detailItems.Any())
            {
                CustomTaskDialog.Show("Information", "No Detail Items found in the document.");
            ...
            CustomTaskDialog.Show("Success", $"Processed {itemsProcessedCount} Detail Items. Cleared {parametersClearedCount} parameter instances.");
            return Result.Succeeded;
        }
    }
}