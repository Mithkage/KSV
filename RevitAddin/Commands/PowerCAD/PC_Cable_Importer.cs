// This needs to be antiquated and replaced using extensible storage. 
...
namespace RTS.Commands.PowerCAD
{
    ...
    public class PC_Cable_ImporterClass : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            {
                CustomTaskDialog.Show("Warning", "No valid data rows found in the CSV file (identified by non-empty 'To' column).");
                return Result.Cancelled;
            }
            ...
            if (!detailItems.Any())
            {
                CustomTaskDialog.Show("Warning", "No Detail Items found in the current document.");
                return Result.Cancelled;
            }
            ...
            if (errors.Any())
            {
                ...
                CustomTaskDialog.Show("Import Summary", report.ToString());
        ...
        private void ShowErrorsDialog(List<string> errors)
        {
            ...
            CustomTaskDialog errorDialog = new CustomTaskDialog("Import Issues");
            ...
            const int maxLength = 2000; // Approx limit for CustomTaskDialog
            ...
            errorDialog.CommonButtons = CustomTaskDialogCommonButtons.Close;
            errorDialog.Show();
        }
    }
}
