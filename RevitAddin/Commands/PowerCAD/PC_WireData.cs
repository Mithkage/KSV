...
using System.Linq;
using System.Text;
using System.Windows.Forms; // For CustomTaskDialog
            ...
            try
            {
                ...
                using (Transaction tx = new Transaction(doc, "Update Electrical Wires from PC_Data"))
                {
                    ...
                    try
                    {
                        ...
                        tx.Commit();
                        CustomTaskDialog.Show("Wire Update Complete", $"Successfully updated {updatedWiresCount} electrical wires based on PC_Data. " +
                    ...
                    catch (Exception ex)
                    {
                        ...
                        CustomTaskDialog.Show("Wire Update Error", message);
