...
namespace RTS.Commands.PDFTools
{
    ...
    public class BB_CableLengthImport : IExternalCommand // Or use directly in Macro Manager
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            try
            {
                ...
                {
                     CustomTaskDialog.Show("CSV Processing", "No valid data found in the CSV file matching the criteria (Subject='Polylength Measurement', non-blank Label).");
            ...
            catch (Exception ex)
            {
                ...
                CustomTaskDialog.Show("CSV Error", message);
            ...
            using (Transaction t = new Transaction(doc, "Update Cable Lengths Text Param from CSV"))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    CustomTaskDialog.Show("Revit Update Error", message);
            ...
            CustomTaskDialog.Show("Cable Length Update Summary", summary);
