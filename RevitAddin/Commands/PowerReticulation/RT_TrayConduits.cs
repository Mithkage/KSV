...
            ConduitType conduitType = null;
        ...
        // Accessing NominalDiameter via parameter BuiltInParameter.RBS_CONDUIT_DIAMETER_PARAM
...

                {
                    ...
                    CustomTaskDialog.Show("RT_TrayConduits Error", message);
...
                try

                {
...

                    {
                        ...
                        CustomTaskDialog.Show("RT_TrayConduits", "No cable trays with RTS_Cable_XX data found.");
...
            if (successfulConduits.Any())

            {
                ...
                CustomTaskDialog.Show("RT_TrayConduits Report", reportMessage);
...

            {
                ...
                CustomTaskDialog.Show("RT_TrayConduits", "No conduits were created. Check warnings for details.");
