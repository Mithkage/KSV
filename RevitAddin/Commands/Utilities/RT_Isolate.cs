    ...
    public class RT_IsolateClass : IExternalCommand
    {
            ...
            ElementSet elements)
        {
            ...
            if (activeView == null)
            {
                ...
                CustomTaskDialog.Show("RT_Isolate Error", message);
            ...
            Action resetAllGraphics = () =>
            {
                using (Transaction tResetGraphics = new Transaction(doc, "Reset View Graphic Overrides"))
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        CustomTaskDialog.Show("RT_Isolate Warning", $"Failed to reset view graphic overrides: {ex.Message}.");
                    }
            ...
            if (string.IsNullOrWhiteSpace(inputString))
            {
                ...
                resetAllGraphics();
                CustomTaskDialog.Show("RT_Isolate", "Input was blank. All graphic overrides have been cleared from the active view.");
            ...
            if (!searchValues.Any())
            {
                ...
                resetAllGraphics();
                CustomTaskDialog.Show("RT_Isolate", "No valid search values provided. All graphic overrides have been cleared from the active view.");
                return Result.Succeeded;
            }
