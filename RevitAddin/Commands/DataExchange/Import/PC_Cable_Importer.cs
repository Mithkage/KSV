...
namespace RTS.Commands.DataExchange.Import
{
    ...
    public class PC_Cable_ImporterClass : IExternalCommand
    {
        ...
        {
            return RTS.Utilities.FileDialogs.PromptForCsvFile("Select Powercalc SWB Export CSV File");
        }
        ...
        private void ShowErrorsDialog(List<string> errors)
        {
            ...
            TaskDialog taskDialog = new TaskDialog("Import Issues"); // This is the correct way to instantiate
